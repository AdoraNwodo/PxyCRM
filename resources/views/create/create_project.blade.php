                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                 <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="projectname" name="project_name" placeholder="Name" required>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <label for="projectdaterange">Start and End Date </label>
                                    <input type="text" class="form-control" name="project_date_range" id="projectdaterange" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="account" required name="project_account">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="projectmanager" required name="project_manager">
                                        <option selected="selected" disabled value="">Choose Project Manager</option>
                        ...
                        <div class="row">
                            <div class=" col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea rows="6" cols="40" style="width: 100%;" placeholder="Description" id="campaigndescription" required name="project_description"></textarea>
                                 </div>
                            </div>
                        </div>
