            ...
            <div class="box-header" style="background: #d3d3d3;">
              <table id="example2" class="table table-stripped table-hover" style="margin-bottom: -12px; border: none;">
                ...
                <tr>
                    ...
                    <th style="width: 20%;">Start and End Date</th>
            ...
            <div class="box-body">
              <table id="example2" class="table order-table table-stripped table-hover">
                <tbody>
                    ...
                    <tr>
                      <td style="width: 20%;">{{$task->task_subject}}</td>
                      <td style="width: 20%;">{{$task->project_name}}</td>
                      <td style="width: 20%;">{{$task->task_start_and_end_date}}</td>
                      <td style="width: 20%;">{{$task->name}}</td>
                      <td style="width: 12%;">{{$task->created_at}}</td>
                      <td style="width: 8%;">
                          <a href="/task/edit/{{$task->id}}" data-toggle="tooltip" title="Edit">
                            <i class="fa fa-pencil-square-o" style="font-size: 17px;"></i>
                          </a>&nbsp;&nbsp;&nbsp;
                          <a href="/task/view/{{$task->id}}" data-toggle="tooltip" title="View">
